    ...
    m_timer(this)
{
	...
	wxTextCtrl* textCtrl = new wxTextCtrl(this, wxID_ANY, "Focus on your work! Eye Break remind you to take breaks.", wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
